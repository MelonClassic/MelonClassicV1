...
unsigned int nTargetSpacing = 1 * 30; // MelonClassic - 0.5 minute blocks
...
unsigned int nModifierInterval = 10 * 60; // MelonClassic - time to elapse before new modifier is computed
...
const string strMessageMagic = "MelonClassic Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "MelonClassic", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "http://www.bbc.com/news/world-asia-china-39313654";
        CTransaction txNew;
        txNew.nTime = 14898283748;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1489828374;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 17235823;
        ...
        assert(block.hashMerkleRoot == uint256("0x886bcd11f0ea3a82d813b0a61f45be8e69fe31ac310158b7e6f0051f9890ed45"));
