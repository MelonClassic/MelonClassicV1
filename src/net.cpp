...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("MelonClassic-ext-ip");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("MelonClassic-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "MelonClassic " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("MelonClassic-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("MelonClassic-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("MelonClassic-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("MelonClassic-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. MelonClassic is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("MelonClassic-start");
