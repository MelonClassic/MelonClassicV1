...
private slots:
    ...
    void on_BuyMelonClassic_clicked();
    void on_SellMelonClassicBTN_clicked();
    void on_SellBidcomboBox_currentIndexChanged(const QString &arg1);
    void on_Sell_Max_Amount_clicked();
    void on_UnitsInputMelonClassic_textChanged(const QString &arg1);
    ...
    QString BuyMelonClassic(QString OrderType, double Quantity, double Rate);
    QString SellMelonClassic(QString OrderType, double Quantity, double Rate);
