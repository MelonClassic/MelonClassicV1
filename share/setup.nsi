...
!define URL http://www.MelonClassic.ru/

# MUI Symbol Definitions
!define MUI_ICON "../share/pixmaps/MelonClassic.ico"
...
#!define MUI_FINISHPAGE_RUN $INSTDIR\MelonClassic-qt.exe
...
OutFile MelonClassic-0.3.0-win32-setup.exe
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    #File ../release/MelonClassic-qt.exe
    File /oname=license.txt ../COPYING
    File /oname=readme.txt ../doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File ../src/MelonClassicd.exe
    ...
    #Delete /REBOOTOK $INSTDIR\MelonClassic.exe
...
Section /o -un.Main UNSEC0000
    #Delete /REBOOTOK $INSTDIR\MelonClassic-qt.exe
...
Section -un.post UNSEC0001
    ...
    DeleteRegKey HKCR "MelonClassic"
